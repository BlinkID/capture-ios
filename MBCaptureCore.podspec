Pod::Spec.new do |s|
  ...
  s.readme      = "https://raw.githubusercontent.com/BlinkID/capture-ios/v1.4.0/README.md"
  ...
  s.source      = { 
        :http => 'https://github.com/BlinkID/capture-ios/releases/download/v1.4.0/CaptureCore.xcframework.zip'
  }
